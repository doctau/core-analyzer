...
message == an error message without a stack will be printed."),
  ...
  gdbpy_initialize_heap_block ();
  gdbpy_initialize_object_ref ();
...
Return a tuple containing all inferiors." },
  ...
  {"shared_object", gdbpy_shared_object, METH_VARARGS, "Return objects accessed by multiple threads." },
  {"ref", gdbpy_ref, METH_VARARGS, "Return references to the input object." },
  {NULL, NULL, 0, NULL}
};
